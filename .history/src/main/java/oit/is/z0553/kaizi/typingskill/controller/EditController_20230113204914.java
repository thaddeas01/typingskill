...
public class EditController {
  ...
  public String delete(@RequestParam Integer id, ModelMap model) {
    final Vocab VocabDelete = this.vocabsync.syncDeleteVocabs(id-1);
  ...
  @GetMapping("/addvoc")
  @Transactional
  public String addvoc(@RequestParam String voc, ModelMap model){
    final String Addvoc = this.vocabsync.syncAddVocabs(voc);
